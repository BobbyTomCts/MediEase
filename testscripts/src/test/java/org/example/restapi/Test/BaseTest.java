...
//  Dedicated method for POST requests that use Query Parameters (/requests/create).
    ...
    protected Response doRequestWithQueryParams(String endpoint, Long empId, Double amount, Long hospitalId, String token) {
        return RestAssured
                .given(requestSpecification)
                .header("Authorization", "Bearer " + token)
                .queryParam("empId", empId)
    ...
    protected Response doRequestWithQueryParams2(String endpoint, Long empId, Long packageId, String token) {
        return RestAssured
                .given(requestSpecification)
                .header("Authorization", "Bearer " + token)
                .queryParam("empId", empId)
    ...
    protected Response doRequestWithQueryParams1(String endpoint,Long empId, String name, Integer age, String gender, String relation, String token)
    {
        return RestAssured
                .given(requestSpecification)
                .header("Authorization", "Bearer " + token)
    ...
    protected Response doRequestWithQueryParams2(String endpoint, String name, Integer age, String gender, String relation, String token)
    {
        return RestAssured
                .given(requestSpecification)
                .header("Authorization", "Bearer " + token)
...
//     Dedicated method for GET requests with Optional Query Parameters (e.g., /requests/filtered).
    ...
    protected Response doGetWithQueryParams(String endpoint, String status, String startDate, String endDate, String token) {
        RequestSpecification spec = RestAssured.given(requestSpecification);
